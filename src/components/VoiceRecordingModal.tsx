...
export default function VoiceRecordingModal({
  ...
  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-20 backdrop-blur-sm flex items-center justify-center z-[9999] p-4"
      style={{
          ...
          {!showConfirmation ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Vi kommer att granska din ljudinspelning och godkännas så snart
                som möjligt.
              </p>
            </div>
          )}
